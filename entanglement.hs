...
-- 
-- ©2017 Jinlong Huang All Right Reserved
-- ===================================================================================
...
entanglement1 :: Bool -> Bool  -> Circ (Bit, Bit)
entanglement1 var1 var2 = do
...
main = do
  print_generic Preview (entanglement1 False False)
  replicateM_ 10 $
    do
      g <- newStdGen
      print $ run_generic g (0.0 :: Double) (entanglement1 False False)
